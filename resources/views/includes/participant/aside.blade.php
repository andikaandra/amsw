  ...
  <div class="tab-content">
    <div class="tab-pane active" id="timeline" role="tabpanel">
        ...
        <div class="list-group-item list-group-item-accent-{{ Auth::user()->status >= 1 ? (Auth::user()->status == 1 ? 'info' : 'success' ) : 'danger' }} list-group-item-divider">
          <div class="row">
            ...
            <div class="col-2 float-right text-right">
              ...
              <i class="fa fa-chevron-circle-left text-info" aria-hidden="true"></i> @elseif(Auth::user()->status >= 2)
              <i class="fa fa-check text-success" aria-hidden="true"></i> @else
              <i data-toggle="tooltip" title="You aren't up to this step yet." class="fa fa-times text-danger" aria-hidden="true"></i>              @endif
            </div>
          </div>
        </div>
        <div class="list-group-item list-group-item-accent-{{ Auth::user()->status >= 2 ? (Auth::user()->status == 2 ? 'info' : 'success' ) : 'danger' }} list-group-item-divider">
          <div class="row">
            ...
            <div class="col-2 float-right text-right">
              ...
              <i class="fa fa-chevron-circle-left text-info" aria-hidden="true"></i> @elseif(Auth::user()->status >= 3)
              <i class="fa fa-check text-success" aria-hidden="true"></i> @else
              <i data-toggle="tooltip" title="You aren't up to this step yet." class="fa fa-times text-danger" aria-hidden="true"></i>              @endif
            </div>
          </div>
        ...
        <div class="list-group-item list-group-item-accent-{{ Auth::user()->status >= 3 ? (Auth::user()->status == 3 ? 'info' : 'success' ) : 'danger' }} list-group-item-divider">
          <div class="row">
            ...
            <div class="col-2 float-right text-right">
              ...
              <i class="fa fa-chevron-circle-left text-info" aria-hidden="true"></i> @elseif(Auth::user()->status >= 4)
              <i class="fa fa-check text-success" aria-hidden="true"></i> @else
              <i data-toggle="tooltip" title="You aren't up to this step yet." class="fa fa-times text-danger" aria-hidden="true"></i>              @endif
            </div>
          </div>
        ...
        <div class="list-group-item list-group-item-accent-{{ Auth::user()->status >= 4 ? (Auth::user()->status == 4 ? 'info' : 'success' ) : 'danger' }} list-group-item-divider">
          <div class="row">
            ...
            <div class="col-2 float-right text-right">
              ...
              <i class="fa fa-chevron-circle-left text-info" aria-hidden="true"></i> @elseif(Auth::user()->status >= 5)
              <i class="fa fa-check text-success" aria-hidden="true"></i> @else
              <i data-toggle="tooltip" title="You aren't up to this step yet." class="fa fa-times text-danger" aria-hidden="true"></i>              @endif
            </div>
          </div>
      ...
      <div class="list-group list-group-accent">
        ...
        @if(Auth::user()->status
        < 5) <div data-toggle="tooltip" title="You aren't up to this step yet." class="list-group-item list-group-item-accent-danger list-group-item-divider">
          ...
          <div class="list-group-item list-group-item-accent-warning list-group-item-divider">
            ...
            <div class="list-group-item list-group-item-accent-info list-group-item-divider">
              ...
              @if(Auth::user()->status
              < 6) <div data-toggle="tooltip" title="You aren't up to this step yet." class="list-group-item list-group-item-accent-danger list-group-item-divider">
                @elseif(Auth::user()->status == 6 )
                <div class="list-group-item list-group-item-accent-warning list-group-item-divider">
                    ...
                    <div class="list-group-item list-group-item-accent-success list-group-item-divider">
                      ...
                      <div class="row">
                        ...
                        <div class="col-2 float-right text-right">
                          ...
                          <i data-toggle="tooltip" title="Committee is still reviewing your final registration data." class="fa fa-question-circle"
                            aria-hidden="true"></i> @elseif(Auth::user()->status == 7)
                          <i class="fa fa-chevron-circle-left text-info" aria-hidden="true"></i> @elseif(Auth::user()->status
                          > 7)
                          <i class="fa fa-check text-success" aria-hidden="true"></i> @else
                          <i data-toggle="tooltip" title="You aren't up to this step yet." class="fa fa-times text-danger" aria-hidden="true"></i>                          @endif
