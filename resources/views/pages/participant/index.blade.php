...
{{--           <div class="col-sm-7 d-none d-md-block text-right">
        ...
        <hr>
        <div class="chart-wrapper mt-3" style="min-height:300px;" data-step="1" data-intro="This is your dashboard. You will find relevant information like payment and account status, submissions and many things">
          {{-- Not verified yet --}}
